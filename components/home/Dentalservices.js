  ...
  var Details = [
    {
      ...
      links: '/services/root-canal-treatment-in-borivali-west'
    ...
    },
    {
      ...
      links: '/services/dental-implants-in-borivali-west'
    },
    {
      ...
      links: '/services/dental-veneers-in-borivali-west'
...

    {
      ...
      links: '/services/full-mouth-rehabilitation-in-borivali-west'
    ...
    },
    {
      ...
      links: '/services/teeth-whitening-in-borivali-west'
    ...
    },
    {
      ...
      links: '/services/braces-and-aligners-in-borivali-west'
    ...
    },
    {
      ...
      links: '/services/pediatric-dentist-in-borivali-west'
          ...
          <Container component={motion.div} variants={containerVariants} initial="hidden" animate="visible">
            ...
            <Grid container spacing={2}>
              ...
              {Details.slice(0, isMobile ? visibleCards : Details.length).map((item, i) => (
                <Grid item xs={12} sm={6} md={4} key={i} sx={{ display: 'flex', mt: 3 }}>
                  <motion.div
                  ...
                  >
                    <Card
                      sx={{
                        ...
                        '&:hover': {
                          ...
                          boxShadow: 'rgba(0, 0, 0, 0.25) 0px 8px 20px', // deeper shadow
                        },
                        //   '&:hover': {
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          position: 'absolute',
                          top: '-35px', // ✅ Moves it half outside
                          left: '50%',
                      ...
                      >
                        <Avatar
                          ...
                          sx={{
                            ...
                            // boxShadow: '0 4px 10px rgba(0,0,0,0.2)', // Optional shadow for effect
                          }}
                        >
                          <Image
                      ...
                      <Grid container spacing={3} alignItems="center" justifyContent="center" textAlign="center">
                        <Grid item xs={12}>
                          <Typography variant="h4" sx={{ fontFamily: "League Spartan, sans-serif", fontWeight: 500, color: 'primary.dark', fontSize: '20px', mt: 4 }}>
                            {item.title}
                          </Typography>
                          <p style={{ marginTop: 3, textAlign: 'justify' }}>{item.desc}</p>
                        </Grid>

                        {/* <Button variant="contained" sx={{backgroundImage: 'linear-gradient(to right, #2f58b1 0%, #01a6a2 100%)', mt: 3 }} onClick={handleShowMore}> */}
                        <Typography
                          sx={{
                            fontWeight: 'bold',
                            color: 'primary.light',
                          ...
                          onClick={() => window.open(item.links, '_self')}
                        >
                          Explore More
                          <motion.span
                            style={{
                              ...
                              lineHeight: 1,
                              textShadow: '1px 1px 1px rgba(0,0,0,0.2)', // gives it a thicker feel

                            }}
                            className='paras'
                            animate={{ x: [0, 5, 0] }} // smooth left-right
